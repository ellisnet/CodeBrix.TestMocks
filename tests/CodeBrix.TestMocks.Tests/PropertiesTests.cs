...
public class PropertiesTests
{
    ...
    public void Cannot_Setup_virtual_but_sealed_property()
    {
        ...
        Assert.NotEqual("mocked B", b); // it simply shouldn't be possible for Mock to intercept a sealed property;
        Assert.NotNull(exception);      // and Mock should tell us by throwing an exception.
    }
    ...
    public void Cannot_Setup_virtual_but_sealed_property_that_implicitly_implements_a_property_from_inaccessible_interface()
    {
        ...
        Assert.NotEqual("mocked D", d); // it simply shouldn't be possible for Mock to intercept a sealed property;
        Assert.NotNull(exception);      // and Mock should tell us by throwing an exception.
    }
