...
public class ExpressionExtensionsTests
{
    ...
    {
        Expression<Action<ExpressionExtensionsTests>> expr1 = f => f.Do("");
        Expression<Action<ExpressionExtensionsTests>> expr2 = f => f.Do(5);
    ...
    public void PrefixesStaticMethodWithClass()
    {
        ...
        Assert.Contains("ExpressionExtensionsTests.DoStatic(5)", value);
    }
    ...
    public void PrefixesStaticGenericMethodWithClass()
    {
        ...
        Assert.Contains("ExpressionExtensionsTests.DoStaticGeneric<int>(5)", value);
    }
