...
public class ReturnsValidationTests
{
    Mock<IType> mock;
    ISetup<IType, IType> setup;
    ISetup<IType, IType> setupNoArgs;

    public ReturnsValidationTests()
    {
    ...
    {
        Func<IType> delegateWithoutParameters = new ReturnsValidationTests().ExtensionMethodNoArgs;
        this.setupNoArgs.Returns(delegateWithoutParameters);
    ...
    {
        Func<object, object, IType> delegateWithWrongParameterCount = new ReturnsValidationTests().ExtensionMethod;
    ...
    {
        Func<object, object, IType> delegateWithCorrectParameterCount = new ReturnsValidationTests().ExtensionMethod;
...
static class ReturnsValidationTestsExtensions
{
    internal static ReturnsValidationTests.IType ExtensionMethod(this ReturnsValidationTests fixture, object arg1, object arg2)
    {
        return default(ReturnsValidationTests.IType);
    }

    internal static ReturnsValidationTests.IType ExtensionMethodNoArgs(this ReturnsValidationTests fixture)
    {
        return default(ReturnsValidationTests.IType);
    }
}