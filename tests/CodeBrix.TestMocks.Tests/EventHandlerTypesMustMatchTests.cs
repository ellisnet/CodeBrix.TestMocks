...
public class EventHandlerTypesMustMatchTests
{
    [Fact]
    ...
    [Fact]
    public void Mock_requires_event_handlers_to_have_the_exact_same_type()
    {
    ...
    [Fact]
    public void Mock_throws_if_event_handlers_do_not_have_the_exact_same_type()
    {
        var mouseMock = new Mock<Mouse>();
        var mouse = mouseMock.Object;
