...
public class GeneratedReturnsExtensionsTests
{
    ...
    public async Task ReturnsAsync_onMultiParameter_ParametersUsedForCalculationOfTheResult()
    {
        ...
        string evaluationResult = await mock.Object.WithMultiParameterAsync("Mock", "4");

        Assert.Equal("Mock4", evaluationResult);
    }
    ...
    public async Task ReturnsAsync_onMultiParameter_LazyEvaluationOfTheResult()
    {
        ...
        string firstEvaluationResult = await mock.Object.WithMultiParameterAsync("Mock", "4");
        string secondEvaluationResult = await mock.Object.WithMultiParameterAsync("Mock", "4");
