...
using CodeBrix.TestMocks.Mocking.Properties;
...
{
    public class IssueReportsTests
    {
        // @ GitHub
        ...
        {
            [Fact]
            public void WhenMockEncountersTypeThatDynamicProxyCannotHandleFallbackToEmptyDefaultValue()
            {
                ...
                // With such a type, Mock should fall back to the empty default value provider:
                var foo = Mock.Of<Foo>();
        ...
        public class Issue175
        {
            ...
            public void MockErrors()
            {
                ...
                // BUGBUG: Seems to have been set back to the default for this type (Mock type is by default LOOSE)
                Assert.Equal(42, frobber.ExtendedTypeValue);  // "BUGBUG: Mock Lost the value and set back to default."
            }
...
#pragma warning restore xUnit1031 // Do not use blocking task operations in test method
        ...
        {
            readonly Exception _exception1 = new ArgumentException();
            readonly Exception _exception2 = new ArgumentException();
            bool _ownExceptionUnobserved;
            ...
            {
                // Only track unobserved exceptions that belong to this test,
                // not faulted tasks leaked from other tests in the same process.
                if (e.Exception.InnerExceptions.Any(ex =>
                        ReferenceEquals(ex, _exception1) || ReferenceEquals(ex, _exception2)))
                {
                    _ownExceptionUnobserved = true;
                }
            }
            ...
            {
                var mock = new Mock<IFoo>();
                mock.Setup(a => a.Foo()).ThrowsAsync(_exception1);
                mock.SetupSequence(a => a.Boo()).ThrowsAsync(_exception2);
            }
            ...
            public void Dispose()
            {
                ...
                TaskScheduler.UnobservedTaskException -= OnUnobservedTaskException;
                Assert.False(_ownExceptionUnobserved,
                    "ThrowsAsync caused an UnobservedTaskException.");
            }
        ...
        public class Issue605
        {
            ...
            [Fact]
            public void Struct_ByRef_Mock_Test()
            {
                _ = Mock.Of<IStructByRefConsumer>();
            }

            [Fact]
            public void Struct_ByRef_Generic_Mock_Test()
            {
                _ = Mock.Of<IGenericStructByRefConsumer<int>>();
            }

            [Fact]
            public void Struct_ByValue_Mock_Test()
            {
                _ = Mock.Of<IStructByValueConsumer>();
            }

            // Mock used to perform its own System.Reflection.Emit-ting for mocking delegate types,
        ...
        public class Issue706
        {
            ...
            public void CallBase_should_not_be_allowed_for_void_delegate_mocks()
            {
                ...
                CodeBrix.TestMocks.Mocking.Language.Flow.ISetup<Action> setup = mock.Setup(m => m());

                Exception ex = Assert.Throws<NotSupportedException>((Action)(() => setup.CallBase()));
            ...
            public void CallBase_should_not_be_allowed_for_non_void_delegate_mocks()
            {
                ...
                CodeBrix.TestMocks.Mocking.Language.Flow.ISetup<Func<bool>, bool> setup = mock.Setup(m => m());
        ...
        public class Issue893
        {
            ...
            [Fact]
            public void Mock_can_distinguish_between_two_events_having_same_name()
            {
...
public class Issue1209
        ...
        public void MatchesLatestExpectations()
        {
            ...
            mock.Setup(m => m.Method(It.IsInRange<int>(0, 20, CodeBrix.TestMocks.Mocking.Range.Inclusive))).Returns(1);
...
#pragma warning restore 618
        ...
        public class _158
        {
            ...
            public void ShouldRenderCustomMessage()
            {
                ...
                Assert.Contains("once, but was", ex.Message); // has Mock's default message
            }
        }
        ...
        public class _230
        {
            ...
            public void ByteArrayCallbackArgumentShouldNotBeNull()
            {
                ...
                stream.Object.ReadExactly(contents, 0, (int)stream.Object.Length);
            }
        }
