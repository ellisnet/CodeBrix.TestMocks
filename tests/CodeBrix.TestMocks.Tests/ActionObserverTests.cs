...
public class ActionObserverTests
{
    public class Reconstructibility
    {
        ...
        {
            AssertReconstructable(
                "x => x[1] = It.IsAny<ActionObserverTests.Reconstructibility.IY>()",
                 x => x[1] = It.IsAny<ActionObserverTests.Reconstructibility.IY>());
        }
        ...
        public void Widening_and_narrowing_and_enum_convertions()
        {
            ...
            AssertReconstructable(
                "x => x.VoidWithObject(ActionObserverTests.Reconstructibility.Color.Green)",
                 x => x.VoidWithObject(Color.Green));
            AssertReconstructable(
                "x => x.VoidWithEnum(ActionObserverTests.Reconstructibility.Color.Green)",
                 x => x.VoidWithEnum(Color.Green));
            AssertReconstructable(
                "x => x.VoidWithNullableEnum(ActionObserverTests.Reconstructibility.Color.Green)",
