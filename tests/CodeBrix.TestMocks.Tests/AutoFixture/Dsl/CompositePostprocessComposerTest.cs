...
namespace CodeBrix.TestMocks.Tests.AutoFixture.Dsl; //was previously: namespace AutoFixtureUnitTest.Dsl;
...
public class CompositePostprocessComposerTest
{
    ...
    public void WithSpecimenBuilderReturnsCorrectResult()
    {
        // Arrange
        Expression<Func<PropertyHolder<object>, object>> expectedExpression = x => x.Property;
        var builder = new CodeBrix.TestMocks.AutoFixture.ElementsBuilder<object>(new object());
