...
public class FixtureIntegrationWithAutoMockCustomizationTest
{
    [Fact]
    ...
    {
        // Arrange
        var fixture = new Fixture().Customize(new AutoMockCustomization { ConfigureMembers = true });
...
#pragma warning restore xUnit2000
    ...
    {
        // Arrange
        var fixture = new Fixture().Customize(new AutoMockCustomization { GenerateDelegates = true });
