...
public class AfterReturnCallbackDelegateValidationTests
{
    readonly ISetup<IFoo, bool> setup;

    public AfterReturnCallbackDelegateValidationTests()
    {
    ...
    [Fact]
    public void Callback_before_Returns__delegate_may_use_more_specific_parameter_types()
    {
        var setup = this.setup;
    ...
    [Fact]
    public void Callback_after_Returns__delegate_may_use_more_specific_parameter_types()
    {
        var setup = this.setup.Returns(true);
        setup.Callback((string arg1, string arg2) => { });
    }
