...
namespace CodeBrix.TestMocks.DynamicProxy.Generators; //was previously: namespace Castle.DynamicProxy.Generators;

using System;
using System.Collections.Generic;
using System.Reflection;

using CodeBrix.TestMocks.DynamicProxy.Contributors;
using CodeBrix.TestMocks.DynamicProxy.Generators.Emitters;
using CodeBrix.TestMocks.DynamicProxy.Generators.Emitters.SimpleAST;
using CodeBrix.TestMocks.DynamicProxy.Internal;
using CodeBrix.TestMocks.DynamicProxy.Serialization;
