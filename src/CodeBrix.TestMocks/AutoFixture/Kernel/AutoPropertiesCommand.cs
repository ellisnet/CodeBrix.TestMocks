...
[Obsolete("The generic version of the AutoPropertiesCommand is deprecated. Please use the non-generic version of the AutoPropertiesCommand type.")]
public class AutoPropertiesCommand<T> : ISpecimenCommand, ObsoletedMemberShims.ISpecifiedSpecimenCommand<T>
{
    ...
    /// </param>
    [Obsolete("This method is deprecated. Please use the Execute(object, ISpecimenContext) overload instead.")]
    ...
    /// </returns>
    [Obsolete("This method is deprecated. Please use the this.Specification.IsSpecifiedBy(request) method instead.")]
