...
public class RecursionGuard : ISpecimenBuilderNode
{
    ...
    /// </summary>
    [Obsolete("This constructor overload is obsolete. Please use RecursionGuard(ISpecimenBuilder, IRecursionHandler) instead.", true)]
    ...
    /// Initializes a new instance of the <see cref="RecursionGuard"/> class.
    /// </summary>
    [Obsolete("This constructor overload is obsolete. Please use RecursionGuard(ISpecimenBuilder, IRecursionHandler, IEqualityComparer, int) instead.", true)]
    ...
    /// </summary>
    [Obsolete("This method is obsolete. Use IRecursionHandler.HandleRecursiveRequest instead.", true)]
