...
public class AutoMockCustomization : ICustomization
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AutoMockCustomization"/> class.
    /// <para>
...
#pragma warning restore 618 // Type or member is obsolete
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AutoMockCustomization"/> class with a
    /// <see cref="MockRelay"/>.
    /// </summary>
    /// <param name="relay">The relay.</param>
    [Obsolete("This constructor is obsolete. Please use the AutoMockCustomization() overload (without arguments) instead and set the Relay property.")]
    public AutoMockCustomization(ISpecimenBuilder relay)
    {
    ...
    /// <summary>
    /// If value is <c>true</c>, delegate requests are intercepted and created by Mock.
    ...
    /// <summary>
    /// Customizes an <see cref="IFixture"/> to enable auto-mocking with Mock.
    /// </summary>
