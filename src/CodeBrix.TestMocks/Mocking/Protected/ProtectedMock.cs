...
using CodeBrix.TestMocks.TypeNameFormatter;
using System;
...
namespace CodeBrix.TestMocks.Mocking.Protected; //was previously: namespace Moq.Protected;
    ...
    where T : class
{
    ...
    static Expression ToExpressionArg(Type type, object arg)
    {
    ...
    static IEnumerable<Expression> ToExpressionArgs(MethodInfo method, object[] args)
    {
