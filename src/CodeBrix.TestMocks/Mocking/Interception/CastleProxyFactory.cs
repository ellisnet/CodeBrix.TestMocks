...
using CodeBrix.TestMocks.Mocking.Internals;
...
sealed class CastleProxyFactory : ProxyFactory
{
    ...
    /// <inheritdoc />
    public override object CreateProxy(Type mockType, Mocking.IInterceptor interceptor, Type[] interfaces, object[] arguments)
    {
    ...
    sealed class Interceptor : CodeBrix.TestMocks.DynamicProxy.IInterceptor
    {
        static readonly MethodInfo proxyInterceptorGetter = typeof(IProxy).GetProperty(nameof(IProxy.Interceptor)).GetMethod;

        Mocking.IInterceptor interceptor;

        internal Interceptor(Mocking.IInterceptor interceptor)
        {
            this.interceptor = interceptor;
        }

        public void Intercept(CodeBrix.TestMocks.DynamicProxy.IInvocation underlying)
        {
    ...
    sealed class Invocation : Mocking.Invocation
    {
        CodeBrix.TestMocks.DynamicProxy.IInvocation underlying;

        internal Invocation(CodeBrix.TestMocks.DynamicProxy.IInvocation underlying) : base(underlying.Proxy.GetType(), underlying.Method, underlying.Arguments)
        {
