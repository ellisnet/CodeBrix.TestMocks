================================================================================
README-INDEX: CodeBrix.TestMocks
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.TestMocks.ApacheLicenseForever — mocking, dynamic proxies,
      auto-generated test data and xUnit v3 data attributes in one package.
